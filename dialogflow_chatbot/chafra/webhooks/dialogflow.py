...
class DialogFlow:
    def __init__(self, session_id):
        ...
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/ankit/.config/gcloud/application_default_credentials.json"
        self.session_client = dialogflow.SessionsClient()
        self.session = self.session_client.session_path(DIALOGFLOW_PROJECT_ID, SESSION_ID)


    def send_message_to_dialogflow(self, text_to_be_analyzed):
